...
onMounted(async () => {
  ...
  converterOptions.value = converterManager.getConverterOptions(
    content.value.rawType,
  );
});
    ...
    <div class="flex pt-20 items-center size-full flex-col">
      <div>
        ...
        <ul class="mt-4 space-y-2">
          <li
            v-for="option in converterOptions"
            :key="option.toType + option.fromType"
          >
            <button
